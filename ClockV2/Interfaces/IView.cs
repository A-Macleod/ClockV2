...
namespace ClockV2
{
    ...
    public interface IView
    {
        ...
        /// </summary>
        event FormClosingEventHandler FormClosing;  //  In ClockView, handles showing AlarmView creation button and "Hiding" AlarmView instead of "Closing" the AlarmView to keep the state
